...
## Corpus Check
- 482 files · ~715,993 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9590 nodes · 17911 edges · 523 communities (357 shown, 166 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 2129 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `157dff1e`
...
- package:meettrace/data/services/asr/whisper/whisper_adapter.dart
- referenceTime
- ffi.Opaque
...
## Communities (523 total, 166 thin omitted)
...
Cohesion: 0.03
Nodes (74): createDataControlsViewModel, createMeetingDetailViewModel, createMeetingListViewModel, createModelSettingsViewModel, createRecordingSessionViewModel, createStartMeetingViewModel, MeetTraceViewModelFactories, ../data/repositories/sqflite_diarization_preference_repository.dart (+66 more)
...
Cohesion: 0.02
Nodes (115): dart:io, Directory, BundledModelPreparationService, DownloadableModelException, DownloadableModelProgress, DownloadableModelService, DownloadNetworkKind, ModelDownloadCancellationToken (+107 more)
...
Cohesion: 0.02
Nodes (88): dart:typed_data, _copyAsset, data, main, _modelAsset, package:meettrace/data/services/asr/asr_preview_coordinator.dart, package:meettrace/data/services/asr/whisper_base_standard_asr_engine.dart, package:meettrace/data/services/audio/pcm_audio_level_meter.dart (+80 more)
...
Cohesion: 0.04
Nodes (61): _PreviewTranscriptRepository, SqfliteTranscriptRepository, StartupRecoveryService, DomainInvariantViolation, message, toString, TranscriptSnapshotStatus, ResolveMeetingModelSelection (+53 more)
...
Cohesion: 0.04
Nodes (48): acceptAudio, _activeVersions, cancel, _changes, check, create, createError, delete (+40 more)

### Community 19 - "ggml_new_tensor"
Cohesion: 0.09
Nodes (32): ggml_custom1_op_t, ggml_custom_op_t, ggml_calc_conv_output_size(), ggml_calc_conv_transpose_1d_output_size(), ggml_calc_pool_output_size(), ggml_can_mul_mat(), ggml_col2im_1d(), ggml_conv_2d_direct() (+24 more)

### Community 20 - "meeting_detail_view_model_test.dart"
Cohesion: 0.02
Nodes (118): >, _PendingTranscriptionRunner, _PreviewSummaryRepository, _UnavailableTranscriptionRunner, SqfliteDiarizationPreferenceRepository, SqfliteProcessingTaskRepository, SqfliteSummaryRepository, MeetingState (+110 more)

### Community 21 - "ops.cpp"
Cohesion: 0.06
Nodes (133): ggml_op_pool, ggml_compute_forward(), ggml_compute_params, ggml_tensor, T, ggml_compute_forward_acc(), ggml_compute_forward_add_id(), ggml_compute_forward_add_id_f32() (+125 more)
...
Cohesion: 0.05
Nodes (36): Object? error,
  bool, package:meettrace/data/services/summary/summary_generation_service.dart, package:meettrace/domain/use_cases/generate_summary.dart, _SummaryService, active, available, capability, delete (+28 more)

### Community 26 - "ggml_dup_tensor"
Cohesion: 0.04
Nodes (65): ggml_custom3_op_t, ggml_acc(), ggml_acc_impl(), ggml_acc_inplace(), ggml_add_id(), ggml_add_impl(), ggml_add_inplace(), ggml_add_or_set() (+57 more)
...
Cohesion: 0.03
Nodes (73): accept, build, check, _chunkSequence, _controller, _copyAsset, create, createState (+65 more)

### Community 30 - "speaker_diarization_coordinator_test.dart"
Cohesion: 0.04
Nodes (44): asr_engine.dart, Meeting, TranscriptSnapshot, FinalTranscriptionProgressCallback, FinalTranscriptionResult, meeting, snapshot, transcribe (+36 more)
...
Cohesion: 0.03
Nodes (67): class, ../../../../domain/models/asr_model_registry.dart, ../../../../../domain/models/meeting.dart, ../../../../domain/models/model_installation.dart, ../../../domain/models/model_usage_lease.dart, ../../../../../domain/models/processing_task.dart, ../../../domain/ports/summary_generation.dart, _appDatabase (+59 more)
...
Cohesion: 0.02
Nodes (80): AudioRecorder, _DeterministicPcmAudioCapture, main, _recordingSeconds, DeviceRecordingStorageCapacityProvider, dispose, hasPermission, meettracePcmRecordConfig (+72 more)

### Community 38 - "ggml_backend_load_best"
Cohesion: 0.17
Nodes (16): dl_handle, HMODULE, path, dl_error(), dl_get_sym(), dl_handle_deleter, dl_load_library(), backend_filename_extension() (+8 more)
...
Cohesion: 0.07
Nodes (26): ../../../../domain/models/asr_model.dart, ../../../../../domain/models/workflow_states.dart, _date, fromMillisecondsSinceEpoch, meetingFromRow, meetingToRow, modelInstallationFromRow, modelInstallationToRow (+18 more)
...
Cohesion: 0.07
Nodes (27): _PreviewMeetingReadinessChecker, _ReadyMeetingChecker, AsrModelRegistry, check, CheckMeetingReadinessUseCase, device, freeBytes, installations (+19 more)

### Community 54 - "ggml_backend_buffer_t"
Cohesion: 0.11
Nodes (27): ggml_tallocr_alloc(), ggml_vbuffer_tensor_alloc(), ggml_backend_buffer_t, ggml_backend_buffer_clear(), ggml_backend_buffer_get_alignment(), ggml_backend_buffer_get_alloc_size(), ggml_backend_buffer_get_base(), ggml_backend_buffer_get_size() (+19 more)
...
### Community 56 - "ggml.c"
Cohesion: 0.03
Nodes (82): ggml_fp16_t, ggml_log_callback, ggml_abs_inplace(), ggml_add_cast(), ggml_add_cast_impl(), ggml_can_repeat_rows(), ggml_ceil_inplace(), ggml_elu_inplace() (+74 more)
...
Cohesion: 0.13
Nodes (30): ggml_backend_buffer_type_t, ggml_backend_alloc_buffer(), ggml_backend_buffer_get_max_size(), ggml_backend_buffer_init(), ggml_backend_buft_alloc_buffer(), ggml_backend_buft_get_alignment(), ggml_backend_buft_get_max_size(), ggml_backend_cpu_buffer_from_ptr() (+22 more)
...
### Community 61 - "recording_checkpoint_store.dart"
Cohesion: 0.07
Nodes (26): ../../../../../domain/models/asr_preview.dart, int get, delete, fromJson, hashCode, JsonRecordingCheckpointStore, layout, load (+18 more)

### Community 62 - "whisper_asr_engine_factory_test.dart"
Cohesion: 0.03
Nodes (66): changes, inspect, main, _modelRoot, _prepareDelaySeconds, _SupportedRiskMonitor, SqfliteModelUsageLeaseRepository, AndroidProcAsrDeviceRiskMonitor (+58 more)
...
Cohesion: 0.06
Nodes (27): package:flutter_test/flutter_test.dart, package:meettrace/data/services/audio/device_recording_storage_capacity.dart, package:meettrace/data/services/models/platform_download_preflight_providers.dart, package:meettrace/data/services/storage/device_free_space_service.dart, package:meettrace/domain/models/asr_model.dart, package:meettrace/ui/core/view_state.dart, StateError, _dartFilesUnder (+19 more)

### Community 66 - "data_controls_view_model.dart"
Cohesion: 0.05
Nodes (38): device_free_space_service.dart, ../../../../domain/models/data_control.dart, ../../../../domain/ports/local_data_control.dart, ../../../../domain/ports/text_share.dart, ../../../../domain/use_cases/build_meeting_share.dart, share, SharePlusTextShareService, buildDiagnostics (+30 more)
...
Cohesion: 0.09
Nodes (24): ggml_backend_sched_t, whisper_vad_params, samples_to_cs(), whisper_sched, sched, whisper_vad_context, backends, buffer (+16 more)
...
Cohesion: 0.04
Nodes (74): ggml_n_dims(), cs_to_samples(), dft(), dtw_and_backtrace(), fft(), median_filter(), median_filter_user_data, filter_width (+66 more)
...
### Community 72 - "start_meeting.dart"
Cohesion: 0.09
Nodes (22): check_meeting_readiness.dart, _disposeBestEffort, engine, engineFactory, execute, failure, meeting, meetings (+14 more)

### Community 73 - "ggml-cpu.cpp"
Cohesion: 0.06
Nodes (56): ggml_threadpool_t, ggml_guid_t, ggml_abort_callback, ggml_backend_buffer_t, ggml_backend_buffer_type_t, ggml_backend_dev_t, ggml_backend_graph_plan_t, ggml_backend_reg_t (+48 more)
...
### Community 79 - "evidence_playback.dart"
Cohesion: 0.12
...
### Community 81 - "vec.h"
Cohesion: 0.03
Nodes (91): ggml_set_f32(), ggml_set_i32(), ggml_compute_forward_flash_attn_ext_f16_one_chunk(), ggml_compute_forward_out_prod(), ggml_compute_forward_out_prod_f32(), ggml_compute_forward_out_prod_q_f32(), ggml_compute_forward_swiglu_f32(), ggml_fp16_t (+83 more)
...
Cohesion: 0.07
Nodes (28): _PreviewMeetingRepository, _PreviewMeetingRepository, TranscriptRevisionException, MeetingRepository, package:meettrace/domain/use_cases/revise_final_transcript.dart, _MeetingRepository, _MeetingRepository, _Meetings (+20 more)

### Community 88 - "whisper_vad_model"
Cohesion: 0.09
Nodes (23): whisper_vad_model, buffers, ctxs, encoder_0_bias, encoder_0_weight, encoder_1_bias, encoder_1_weight, encoder_2_bias (+15 more)

### Community 89 - "dart:async"
Cohesion: 0.03
Nodes (79): AnimatedContainer, _PreviewMeetingFileDeletionService, Completer, dart:async, FTappable, channelCount, RecordingContinuityProbe, run (+71 more)

### Community 90 - "ggml_set_op_params_i32"
Cohesion: 0.07
Nodes (29): ggml_arange(), ggml_argsort(), ggml_argsort_top_k(), ggml_calc_conv_transpose_output_size(), ggml_concat(), ggml_conv_transpose_2d_p0(), ggml_fill(), ggml_fill_impl() (+21 more)

### Community 91 - "ggml-cpu/repack.cpp"
Cohesion: 0.03
Nodes (72): block_q4_0x4, block_q4_0x8, block_q8_0x16, block_q8_0x4, ggml_quantize_mat_q8_K_4x8(), block_iq4_nlx4, d, qs (+64 more)

### Community 92 - "Exception"
Cohesion: 0.06
Nodes (30): Exception, WhisperAdapterException, BundledModelPreparationException, _PreparationFailure, ModelDownloadCanceledException, available, code, endMs (+22 more)

### Community 93 - "run_final_transcription.dart"
Cohesion: 0.10
Nodes (19): code, engineFactory, _errorCode, FinalTranscriptionException, FinalTranscriptionSnapshotIdFactory, _meetingOperations, meetings, _runAfter (+11 more)

### Community 94 - "whisper_layer_encoder"
Cohesion: 0.12
...
Cohesion: 0.08
Nodes (30): ggml_abs(), ggml_add1_or_set(), ggml_can_out_prod(), ggml_ceil(), ggml_compute_backward(), ggml_elu(), ggml_exp(), ggml_expm1() (+22 more)
...
Cohesion: 0.04
Nodes (46): AsrDeviceRiskState get, InvalidStateTransitionException, package:meettrace/domain/models/meeting.dart, package:meettrace/domain/models/transcript.dart, package:meettrace/domain/models/workflow_states.dart, package:meettrace/domain/use_cases/build_meeting_share.dart, required TranscriptSnapshotStatus status,
  List, String? activeSummaryId,
  MeetingState (+38 more)

### Community 99 - "ggml-backend.cpp"
Cohesion: 0.06
Nodes (91): ggml_backend_eval_callback, ggml_backend_dev_t, ggml_backend_event_t, ggml_backend_graph_plan_t, ggml_backend_sched_t, ggml_backend_t, ggml_guid_t, fmt_size() (+83 more)
...
### Community 103 - "powerpc/quants.c"
Cohesion: 0.05
Nodes (64): Float, ggml_vec_dot_iq4_nl_q8_0(), ggml_vec_dot_iq4_xs_q8_K(), ggml_vec_dot_mxfp4_q8_0(), ggml_vec_dot_q2_K_q8_K(), ggml_vec_dot_q3_K_q8_K(), ggml_vec_dot_q4_0_q8_0(), ggml_vec_dot_q4_1_q8_1() (+56 more)
...
Cohesion: 0.04
Nodes (72): ffi.Struct, mt_whisper_config_v1, mt_whisper_vad_config_v1, atomic_bool, vector, whisper_vad_params, mt_whisper_cancel(), mt_whisper_config_v1_init() (+64 more)
...
Cohesion: 0.05
Nodes (131): bytes_from_bits_32(), bytes_from_nibbles_32(), __m128, __m128i, __m256, get_scale_shuffle(), get_scale_shuffle_k4(), get_scale_shuffle_q3k() (+123 more)

### Community 115 - "vector"
Cohesion: 0.07
Nodes (50): pair, vector, decode_utf8(), get_signal_energy(), log_mel_spectrogram(), log_mel_spectrogram_worker_thread(), map_processed_to_original_time(), whisper_compute_logprobs() (+42 more)
...
Cohesion: 0.12
Nodes (49): ggml_backend_buffer_t, ggml_backend_dev_t, ggml_backend_t, ggml_guid_t, ggml_backend_buffer_is_meta(), ggml_backend_buffer_type_i, ggml_backend_dev_is_meta(), ggml_backend_is_meta() (+41 more)

### Community 121 - "arm/repack.cpp"
Cohesion: 0.04
Nodes (73): quantize_row_q8_0(), quantize_row_q8_1(), int16x8_t, decode_q_Kx8_6bit_scales(), ggml_gemm_iq4_nl_4x4_q8_0(), ggml_gemm_mxfp4_4x4_q8_0(), ggml_gemm_q4_0_4x4_q8_0(), ggml_gemm_q4_0_4x8_q8_0() (+65 more)
...
### Community 123 - "ggml_backend_buffer_free"
Cohesion: 0.29
Nodes (10): mt_whisper_destroy(), mt_whisper_vad_destroy(), ggml_backend_buffer_free(), ggml_backend_free(), aheads_masks_free(), whisper_batch_free(), whisper_free(), whisper_free_state() (+2 more)
...
Cohesion: 0.05
Nodes (63): cpu_set_t, ggml_bf16_t, ggml_fp16_t, ggml_backend_cpu_get_features(), ggml_compute_forward_mul_mat_id_one_chunk(), ggml_cpu_bf16_to_fp32(), ggml_cpu_fp16_to_fp32(), ggml_cpu_fp32_to_bf16() (+55 more)

### Community 127 - "ggml-impl.h"
Cohesion: 0.06
Nodes (53): ggml_bitset_t, initializer_list, ggml_cpu_try_fuse_ops(), ggml_build_backward_expand(), ggml_can_fuse_subgraph_ext(), ggml_graph_cpy(), ggml_graph_get_grad(), ggml_graph_get_grad_acc() (+45 more)
...
Cohesion: 0.18
Nodes (19): ggml_opt_context_t, ggml_opt_epoch_callback, ggml_graph_reset(), ggml_opt_alloc(), ggml_opt_context_optimizer_type(), ggml_opt_dataset_get_batch(), ggml_opt_epoch(), ggml_opt_free() (+11 more)
...
Cohesion: 0.06
Nodes (74): ggml_backend_tensor_memset(), ggml_backend_cpu_device_supports_op(), ggml_compute_forward_mul_mat_one_chunk(), ggml_get_n_tasks(), ggml_get_type_traits_cpu(), ggml_graph_plan(), ggml_type, ggml_call_mul_mat() (+66 more)
...
### Community 142 - "ggml_format_name"
Cohesion: 0.16
Nodes (23): ggml_cont(), ggml_cont_impl(), ggml_conv_1d(), ggml_conv_1d_dw(), ggml_conv_1d_dw_ph(), ggml_conv_1d_ph(), ggml_conv_2d(), ggml_conv_2d_dw() (+15 more)
...
Cohesion: 0.09
Nodes (50): get_thread_range(), pair, ggml_compute_forward_add1(), ggml_compute_forward_add1_bf16_bf16(), ggml_compute_forward_add1_bf16_f32(), ggml_compute_forward_add1_f16_f16(), ggml_compute_forward_add1_f16_f32(), ggml_compute_forward_add1_f32() (+42 more)
...
Cohesion: 0.12
Nodes (19): block_iq3_s, block_iq3_xxs, ggml_quantize_free(), ggml_quantize_init(), dequantize_row_iq3_s(), dequantize_row_iq3_xxs(), iq2xs_free_impl(), iq3_data_index() (+11 more)
...
Cohesion: 0.05
Nodes (47): backend_config, ggml_backend_buffer_ptr, ggml_backend_comm_allreduce_tensor_t, ggml_backend_meta_get_split_state_t, ggml_backend_meta_split_state, ggml_context_ptr, ggml_backend_dev_description(), ggml_cgraph (+39 more)
...
### Community 160 - "_"
Cohesion: 0.10
Nodes (21): AsrEngineMetrics get, _, acceptAudio, cancel, _core, descriptor, deviceRisk, deviceRisks (+13 more)
...
### Community 163 - "manage_recording_session.dart"
Cohesion: 0.13
...
### Community 165 - "ggml_new_tensor_4d"
Cohesion: 0.15
Nodes (15): ggml_tensor, ggml_cont_1d(), ggml_cont_2d(), ggml_cont_3d(), ggml_cont_4d(), ggml_get_rows(), ggml_interpolate(), ggml_interpolate_impl() (+7 more)

### Community 166 - "benchmarks/evaluate_alpha_release.dart"
Cohesion: 0.15
Nodes (11): package:meettrace/domain/use_cases/evaluate_alpha_release.dart, main, _passingInput, EvaluateAlphaReleaseCliOptions, expectedLength, input, main, options (+3 more)
...
Cohesion: 0.08
Nodes (36): ggml_gemm_q4_0_8x8_q8_0(), ggml_gemv_q4_0_8x8_q8_0(), ggml_gemm_q4_0_8x8_q8_0(), ggml_gemv_q4_0_8x8_q8_0(), __avx512_f32cx8x2_load(), __avx512_repeat_f32cx16_load(), __avx_f32cx8_load(), __avx_rearranged_f32cx8_load() (+28 more)
...
Cohesion: 0.06
Nodes (33): gguf_add_tensor(), gguf_find_tensor(), gguf_get_n_tensors(), gguf_get_tensor_name(), gguf_get_tensor_offset(), gguf_get_tensor_size(), gguf_get_tensor_type(), gguf_set_tensor_data() (+25 more)

### Community 172 - "ggml_rope_impl"
Cohesion: 0.15
Nodes (13): ggml_get_rows_back(), ggml_is_vector(), ggml_rope(), ggml_rope_custom(), ggml_rope_custom_inplace(), ggml_rope_ext(), ggml_rope_ext_back(), ggml_rope_ext_inplace() (+5 more)

### Community 173 - "meeting_readiness.dart"
Cohesion: 0.18
...
Cohesion: 0.08
Nodes (48): GGML_KLEIDIAI_MAX_KERNEL_SLOTS, align_up(), ceil_div_size(), array, cpu::extra_buffer_type, cpu::tensor_traits, ggml_backend_buffer_t, ggml_backend_buffer_type_t (+40 more)
...
### Community 184 - "delete_meeting.dart"
Cohesion: 0.18
...
Cohesion: 0.06
Nodes (36): A, B, whisper_decoder, completed, failed, grammar, has_ts, i_batch (+28 more)

### Community 187 - "ggml_cgraph"
Cohesion: 0.18
...
Cohesion: 0.12
Nodes (22): dl_handle_ptr, ggml_backend_reg_t, ggml_backend_reg_dev_count(), ggml_backend_reg_dev_get(), ggml_backend_reg_name(), ggml_backend_reg_t, vector, ggml_backend_reg_by_name() (+14 more)
...
Cohesion: 0.09
Nodes (22): ../../../../../domain/models/app_failure.dart, context, create, _createAdvanced, _createStandard, _failure, _finalVadFactory, installations (+14 more)
...
### Community 217 - "size"
Cohesion: 0.13
Nodes (19): vector, gguf_buffer_reader, data, size, gguf_get_arr_data(), gguf_get_arr_n(), gguf_get_meta_data(), gguf_get_meta_size() (+11 more)
...
Cohesion: 0.10
Nodes (21): ggml_graph_get_tensor(), ggml_graph_node(), ggml_abort_callback, whisper_context, itype, model, path_model, state (+13 more)
...
Cohesion: 0.08
Nodes (30): ggml_compute_forward_flash_attn_back_f32(), ggml_compute_forward_flash_attn_ext_tiled(), ggml_compute_forward_gated_delta_net_one_chunk(), ggml_compute_forward_get_rows_f32(), ggml_compute_forward_norm_f32(), ggml_compute_forward_rms_norm_f32(), ggml_compute_forward_roll_f32(), ggml_compute_forward_scale_f32() (+22 more)
...
Cohesion: 0.24
Nodes (11): FILE, wchar_t, ggml_fopen(), ggml_graph_dump_dot(), ggml_graph_dump_dot_leaf_edge(), ggml_graph_dump_dot_node_edge(), ggml_graph_find(), ggml_graph_get_parent() (+3 more)

### Community 260 - "quantize_row_q1_0_ref"
Cohesion: 0.50
Nodes (4): block_q1_0, quantize_row_q1_0(), dequantize_row_q1_0(), quantize_row_q1_0_ref()

### Community 272 - "nrow_block_q3_k"
Cohesion: 0.40
Nodes (5): nrow_block_q3_k, hmask, qs, scales, scales16

### Community 273 - "dart:convert"
Cohesion: 0.20
Nodes (9): dart:convert, ModelManifestParser, _file, hash, main, _model, models, parser (+1 more)

### Community 274 - "typedef"
Cohesion: 0.20
...
Cohesion: 0.15
Nodes (12): 10. OCR 代码审查, 1. 产品与架构边界, 2. 工具链, 3. 可复现基线, 4. 已确认缺口, 5.1 公开回归轨道, 5. 评测输入契约, 6. Hard Gate 0 (+4 more)
...
Cohesion: 0.18
Nodes (17): gguf_find_key(), gguf_get_arr_str(), gguf_get_arr_type(), gguf_get_key(), gguf_get_kv_type(), gguf_get_n_kv(), gguf_get_val_bool(), gguf_get_val_f32() (+9 more)
...
Cohesion: 0.12
Nodes (18): ggml_opt_dataset_t, ggml_backend_buffer_t, vector, get_opt_pars, ggml_opt_dataset, buf, ctx, data (+10 more)
...
Cohesion: 0.27
Nodes (10): ggml_opt_result_t, ggml_opt_epoch_callback_progress_bar(), ggml_opt_result, ggml_opt_result_accuracy(), loss, loss_per_datapoint, ncorrect, ndata (+2 more)
...
### Community 367 - "AsrEngine"
Cohesion: 0.22
Nodes (9): _PreviewAsrEngine, WhisperBaseStandardAsrEngine, WhisperSmallAdvancedAsrEngine, WhisperAsrEngine, AsrEngine, _FakeAsrEngine, _Engine, _FakeAsrEngine (+1 more)
...
### Community 392 - "size"
Cohesion: 0.07
Nodes (83): function, ggml_context, ggml_backend_t, ggml_backend_alloc_ctx_tensors(), ggml_backend_alloc_ctx_tensors_from_buft(), ggml_acc_or_set(), ggml_add(), ggml_argmax() (+75 more)
...
Cohesion: 0.07
Nodes (27): e_model, ggml_backend_buffer_t, whisper_aheads_masks, buffer, ctx, m, whisper_model, buffers (+19 more)
...
Cohesion: 0.10
Nodes (30): atomic_int, LONG, atomic_fetch_add(), atomic_load(), atomic_load_explicit(), atomic_store(), clear_numa_thread_affinity(), ggml_graph_compute() (+22 more)
...
Cohesion: 0.22
Nodes (9): quantize_row_q8_0(), quantize_row_q8_0(), quantize_row_q8_0(), quantize_row_q8_0(), quantize_row_q8_0(), quantize_row_q8_0_generic(), block_q8_0, dequantize_row_q8_0() (+1 more)
...
### Community 413 - "ggml_barrier"
Cohesion: 0.17
Nodes (19): memory_order, from_float(), atomic_fetch_add_explicit(), atomic_store_explicit(), atomic_thread_fence(), ggml_barrier(), ggml_compute_forward_mul_mat(), ggml_compute_forward_mul_mat_id() (+11 more)

### Community 414 - "gguf_init_from_reader"
Cohesion: 0.16
Nodes (13): gguf_reader_callback_t, gguf_free(), gguf_get_val_u32(), gguf_init_from_buffer(), gguf_init_from_callback(), gguf_init_from_reader(), gguf_reader, callback (+5 more)
...
Cohesion: 0.50
Nodes (4): block_tq2_0, quantize_row_tq2_0(), dequantize_row_tq2_0(), quantize_row_tq2_0_ref()
...
### Community 420 - "flutter_model_asset_source.dart"
Cohesion: 0.25
Nodes (7): AssetBundle, bundled_model_preparation_service.dart, ModelAssetSource, bundle, FlutterModelAssetSource, load, _FakeAssetSource
...
### Community 427 - "ggml_quantize_chunk"
Cohesion: 0.20
Nodes (17): quantize_row_q6_K(), ggml_quantize_chunk(), ggml_row_size(), block_q6_K, dequantize_row_q6_K(), quantize_mxfp4(), quantize_nvfp4(), quantize_q1_0() (+9 more)
...
### Community 438 - "flutter_model_asset_source_test.dart"
Cohesion: 0.29
Nodes (6): CachingAssetBundle, package:meettrace/data/services/models/flutter_model_asset_source.dart, _FakeAssetBundle, lastKey, load, main
...
### Community 440 - "List"
Cohesion: 0.06
Nodes (28): AsrInstallationType, AsrModelDescriptor, AsrModelTier, capabilities, displayName, installationType, modelId, requiredBytes (+20 more)
...
### Community 442 - "ggml-cpu/quants.c"
Cohesion: 0.12
Nodes (19): block_nvfp4, ggml_vec_dot_nvfp4_q8_0_generic(), quantize_row_mxfp4(), quantize_row_nvfp4(), quantize_row_q3_K(), quantize_row_q4_1(), ggml_fp32_to_ue4m3(), ggml_ue4m3_to_fp32() (+11 more)
...
Cohesion: 0.13
Nodes (25): block_q3_K, quantize_row_q2_K(), quantize_row_q4_K(), quantize_row_q5_K(), block_q2_K, block_q4_K, block_q5_K, dequantize_row_q2_K() (+17 more)
...
### Community 451 - "gguf_write_out"
Cohesion: 0.12
Nodes (17): FILE, T, gguf_file_reader, file, offset, gguf_init_from_file_ptr(), gguf_write_out(), gguf_write_to_file() (+9 more)
...
### Community 459 - "ViewState"
Cohesion: 0.43
Nodes (6): error, value, ViewData, ViewError, ViewLoading, ViewState

### Community 460 - "ggml_print_backtrace"
Cohesion: 0.33
...
### Community 467 - "VoiceActivitySegmenter"
Cohesion: 0.33
Nodes (6): _FailingVoiceActivitySegmenter, StreamingWindowSegmenter, VoiceActivitySegmenter, WhisperVadSegmenter, _ScriptedVad, _ScriptedFinalVad
...
### Community 480 - "ggml_custom_op_params"
Cohesion: 0.40
Nodes (5): ggml_custom_op_params, fun, n_tasks, userdata, ggml_custom_op_t

### Community 481 - "package:meettrace/data/services/asr/whisper/whisper_adapter.dart"
Cohesion: 0.50
Nodes (3): package:meettrace/data/services/asr/whisper/whisper_adapter.dart, package:meettrace/data/services/asr/whisper/whisper_recognizer_profiles.dart, main

### Community 483 - "ffi.Opaque"
Cohesion: 0.67
Nodes (3): ffi.Opaque, mt_whisper_context, mt_whisper_vad_context

### Community 484 - "ggml_map_custom2_impl"
Cohesion: 0.83
...
Cohesion: 0.17
Nodes (13): ggml_opt_get_optimizer_params, ggml_time_us(), ggml_backend_sched_t, ggml_tensor, map, ggml_opt_default_params(), ggml_opt_fit(), ggml_opt_result_free() (+5 more)
...
Cohesion: 0.50
Nodes (4): block_tq1_0, quantize_row_tq1_0(), dequantize_row_tq1_0(), quantize_row_tq1_0_ref()

### Community 494 - "ggml-quants.c"
Cohesion: 0.09
Nodes (32): block_iq1_m, block_iq1_s, block_iq2_s, block_iq2_xs, block_iq2_xxs, quantize_row_q4_0(), block_q4_0, dequantize_row_iq1_m() (+24 more)

### Community 495 - "kleidiai_block_args"
Cohesion: 0.50
Nodes (4): kleidiai_block_args, lhs_bl, pack_bl, rhs_bl
...
## Knowledge Gaps
- **4569 isolated node(s):** `schemaVersion`, `minAppVersion`, `models`, `_MeetingFlowFixture`, `_modelAsset` (+4564 more)
...
- **Why does `_string` connect `_string` to `use_cases/evaluate_alpha_release.dart`, `cpuid_x86`, `size`, `whisper_model`, `vector`, `whisper_state`, `ggml_backend_meta_context`, `gguf_init_from_reader`, `ggml_backend_load_best`, `gguf_set_kv`, `gguf.cpp`, `x86/cpu-feats.cpp`, `whisper_decoder`, `whisper_vocab`, `gguf_write_out`, `whisper_vad_context`, `whisper.cpp`, `ggml-cpu.cpp`, `ggml-backend-reg.cpp`, `whisper_vad_model`, `size`, `whisper_context`, `meettrace_whisper.cpp`, `ime_env.cpp`, `ggml-backend-meta.cpp`?**
  _High betweenness centrality (0.188) - this node is a cross-community bridge._
- **Why does `cpuid_x86` connect `cpuid_x86` to `_string`, `x86/cpu-feats.cpp`, `ggml_backend_cpu_x86_score`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `ggml_type_size()` connect `ggml_is_contiguous` to `ggml_scale_impl`, `quantize_row_iq4_nl_impl`, `size`, `rvv_kernels.cpp`, `ggml_quantize_chunk`, `ggml_compute_forward_flash_attn_back_f32`, `ggml_format_name`, `ggml_nrows`, `vec.h`, `ops.cpp`, `ggml.c`, `ggml_set_op_params_i32`, `ggml_barrier`, `gguf_init_from_reader`?**
...
- **What connects `schemaVersion`, `minAppVersion`, `models` to the rest of the system?**
  _4569 weakly-connected nodes found - possible documentation gaps or missing edges._
