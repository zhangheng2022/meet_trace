...
## Corpus Check
- 408 files · ~151,632 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5431 nodes · 7284 edges · 404 communities (275 shown, 129 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 46 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ff8c59be`
...
## Communities (404 total, 129 thin omitted)
...
Cohesion: 0.05
Nodes (41): _Capacity, Connectivity, SqfliteRuntimeDownloadConsentRepository, DownloadNetworkKind, DownloadNetworkStatusProvider, ModelStorageCapacityProvider, _connectivity, ConnectivityDownloadNetworkStatusProvider (+33 more)
...
Cohesion: 0.06
Nodes (30): dart:convert, files, license, licensePath, modelId, normalized, parse, requiredBytes (+22 more)
...
Cohesion: 0.05
Nodes (42): ../../../../domain/models/asr_model.dart, ../../../domain/models/model_manifest.dart, downloadable_model_service.dart, SileroVadManifest, DownloadableSpeakerDiarizationModelService, DownloadableModelService, download, requireHttps (+34 more)
...
Cohesion: 0.04
Nodes (65): DatabaseFactory, UnsupportedAlphaInstallationException, createPlatformDatabaseFactory, _createWindowsFactory, databaseFactory, databaseFactoryFfi, _windowsDatabaseFactory, StartupRecoveryService (+57 more)
...
Cohesion: 0.05
Nodes (39): _PreviewMeetingRepository, _PreviewMeetingRepository, _PreviewMeetingRepository, SqfliteMeetingRepository, MeetingRepository, package:meettrace/data/services/storage/local_data_control_service.dart, package:meettrace/domain/ports/repositories.dart, package:meettrace/domain/use_cases/revise_final_transcript.dart (+31 more)
...
### Community 53 - "meeting_list_view_test.dart"
Cohesion: 0.08
Nodes (23): AnimatedContainer, FTappable, Icon, package:meettrace/ui/core/app_back_icon.dart, package:meettrace/ui/features/meetings/view_models/list/meeting_list_view_model.dart, RotationTransition, main, _changes (+15 more)
...
Cohesion: 0.12
Nodes (16): delete, fromJson, hashCode, layout, load, meetingId, operator, persistedBytes (+8 more)
...
Cohesion: 0.05
Nodes (36): ChangeNotifier, ../../../../../core/app_status_notice.dart, ../../../../../../domain/models/asr_preview.dart, MeetingListViewModel, RecordingSessionViewModel, StartMeetingViewModel, build, _buildPanel (+28 more)
...
### Community 76 - "List"
Cohesion: 0.05
Nodes (41): List, package:meettrace/domain/models/asr_model_registry.dart, package:meettrace/domain/models/data_control.dart, package:meettrace/domain/models/meeting_readiness.dart, package:meettrace/domain/ports/local_data_control.dart, package:meettrace/domain/ports/text_share.dart, package:meettrace/domain/use_cases/check_meeting_readiness.dart, package:meettrace/domain/use_cases/start_meeting.dart (+33 more)
...
Cohesion: 0.08
Nodes (24): _FakeWorker, _IsolateSherpaOnnxWorker, SherpaOnnxWorker, package:meettrace/data/services/asr/sherpa_onnx/sherpa_onnx_adapter.dart, _Worker, _activeRecognitions, config, create (+16 more)
...
Cohesion: 0.12
Nodes (16): Duration, bytes, calls, delay, error, fileName, layout, main (+8 more)
...
### Community 102 - "GeneratedPluginRegistrant.swift"
Cohesion: 0.14
...
### Community 104 - "device_recording_storage_capacity.dart"
Cohesion: 0.40
...
### Community 116 - "delete_meeting_test.dart"
Cohesion: 0.14
...
### Community 126 - "AsrPreviewSession"
Cohesion: 0.29
...
### Community 143 - "RecordingSessionService"
Cohesion: 0.33
...
Cohesion: 0.05
Nodes (44): Key?, appDisplayName, Application, build, home, AppBackIcon, build, semanticsLabel (+36 more)
...
Cohesion: 0.16
Nodes (14): error, value, ViewData, ViewError, ViewLoading, ViewState, package:meettrace/data/services/audio/device_recording_storage_capacity.dart, package:meettrace/data/services/models/platform_download_preflight_providers.dart (+6 more)
...
Cohesion: 0.22
Nodes (7): dart:typed_data, package:meettrace/domain/models/recording.dart, main, _chunk, main, timeout, _waitFor
...
### Community 227 - "class"
Cohesion: 0.05
Nodes (40): class, ../../../../domain/models/asr_model_registry.dart, ../../domain/models/model_usage_lease.dart, ../../../domain/ports/runtime_asset_preparation.dart, _appDatabase, _enabledKey, getEnabled, setEnabled (+32 more)
...
### Community 238 - "final_transcription.dart"
Cohesion: 0.12
...
### Community 299 - "SpeakerDiarizationWorkerFactory"
Cohesion: 0.67
...
### Community 310 - "Exception"
Cohesion: 0.11
Nodes (19): Exception, _RemoteWorkerError, SherpaOnnxAdapterException, SpeakerDiarizationWorkerException, CacheDirectoryProvider, clear, message, ShareCacheCleaner (+11 more)
...
Cohesion: 0.04
Nodes (46): dart:io, Directory, main, _recordingSeconds, AppFileLayout, commit, DurableFileCommitException, DurableFileCommitter (+38 more)
...
## Knowledge Gaps
- **3825 isolated node(s):** `schemaVersion`, `minAppVersion`, `models`, `_pcmPath`, `_modelDirectory` (+3820 more)
...
- `meeting_list_view.dart` (8× useful, score=6.655526052)
- `Application` (7× useful, score=5.943106813)
- `AsrModelRegistry` (7× useful, score=5.939470299)
- `Meeting` (5× useful, score=4.158171826)
- `theme.dart` (5× useful, score=4.002958725)
- `AsrPreviewCoordinator` (4× useful, score=3.708752734)
- `AppDatabase` (4× useful, score=3.340862439)
- `ios/RunnerTests/RunnerTests.swift` (3× useful, score=2.939417467)
- `SpeakerDiarizationCoordinator` (3× useful, score=2.865051398)
- `SherpaOnnxAsrEngine` (3× useful, score=2.608135266)
