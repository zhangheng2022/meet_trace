...
## Corpus Check
- 479 files · ~710,685 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9447 nodes · 17752 edges · 489 communities (318 shown, 171 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 2129 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fd946200`
...
## Communities (489 total, 171 thin omitted)
...
Cohesion: 0.03
Nodes (73): dart:io, Directory, BundledModelPreparationService, DownloadableModelException, AppFileLayout, commit, DurableFileCommitException, DurableFileCommitter (+65 more)
...
Cohesion: 0.02
Nodes (81): _copyAsset, data, main, _modelAsset, OfficialWhisperWorkerFactory, WhisperWorkerFactory, package:meettrace/data/services/asr/asr_preview_coordinator.dart, package:meettrace/data/services/asr/whisper_base_standard_asr_engine.dart (+73 more)
...
Cohesion: 0.03
Nodes (77): StartupRecoveryService, DomainInvariantViolation, message, toString, TranscriptSnapshotStatus, InvalidStateTransitionException, ResolveMeetingModelSelection, package:meettrace/data/repositories/sqflite_diarization_preference_repository.dart (+69 more)
...
Cohesion: 0.02
Nodes (111): Connectivity, downloadable_model_service.dart, freeSpace, getFreeBytes, addCancelListener, _adoptExistingIfValid, alreadyInstalled, cancel (+103 more)
...
Cohesion: 0.02
Nodes (94): SqfliteModelInstallationRepository, WhisperAsrEngineFactory, AsrEngineFactory, ActiveModelInstallationRepository, package:meettrace/domain/models/asr_model_registry.dart, package:meettrace/domain/models/meeting_readiness.dart, package:meettrace/domain/ports/asr_engine.dart, package:meettrace/domain/use_cases/check_meeting_readiness.dart (+86 more)

### Community 19 - "ggml_new_tensor"
Cohesion: 0.07
Nodes (43): ggml_custom2_op_t, ggml_custom3_op_t, ggml_custom_op_t, ggml_calc_conv_output_size(), ggml_calc_conv_transpose_1d_output_size(), ggml_calc_pool_output_size(), ggml_can_mul_mat(), ggml_can_out_prod() (+35 more)
...
Cohesion: 0.04
Nodes (49): package:crypto/crypto.dart, required Directory audioRoot,
  bool, corruptFirstHash, create, environment, firstAudioPath, _fixture, main (+41 more)
...
### Community 26 - "pcm_evidence_playback_service_test.dart"
Cohesion: 0.18
...
### Community 27 - "ggml_type_size"
Cohesion: 0.11
Nodes (30): ggml_get_n_tasks(), ggml_graph_plan(), ggml_compute_forward_concat(), ggml_compute_forward_concat_any(), ggml_compute_forward_concat_f16(), ggml_compute_forward_concat_f32(), ggml_compute_forward_concat_i8(), ggml_compute_forward_conv_transpose_2d_impl() (+22 more)
...
Cohesion: 0.03
Nodes (75): accept, build, check, _chunkSequence, _controller, _copyAsset, create, createState (+67 more)
...
Cohesion: 0.03
Nodes (69): _csvCell, decoded, deviceId, durationMs, emittedText, energyEvidenceRef, energyWh, evaluate (+61 more)

### Community 32 - "sqflite_model_installation_repository.dart"
Cohesion: 0.04
Nodes (55): class, ../../../../domain/models/asr_model_registry.dart, ../../../domain/models/model_usage_lease.dart, ../../../../../domain/models/processing_task.dart, ../../../domain/ports/summary_generation.dart, _appDatabase, _enabledKey, getEnabled (+47 more)

### Community 33 - "android_whisper_quality_benchmark_test.dart"
Cohesion: 0.05
Nodes (43): _baseModelAsset, byteLength, _completeMarker, _copyAsset, corpusId, data, _DeviceBenchmarkRun, deviceId (+35 more)
...
Cohesion: 0.08
Nodes (33): dl_handle, dl_handle_ptr, HMODULE, ggml_backend_reg_t, path, dl_error(), dl_get_sym(), dl_handle_deleter (+25 more)
...
Cohesion: 0.03
Nodes (59): _PreviewInstallations, device_free_space_service.dart, ../../../../domain/models/data_control.dart, ../../../domain/models/model_manifest.dart, ../../../../domain/ports/local_data_control.dart, alreadyReady, assetSource, BundledModelPreparationPhase (+51 more)
...
Cohesion: 0.04
Nodes (48): asr_engine.dart, ../../../../../domain/use_cases/check_meeting_readiness.dart, captureFactory, check, DeviceRecordingReadinessProbe, PcmAudioCaptureFactory, storageCapacity, Meeting (+40 more)
...
Cohesion: 0.08
Nodes (40): ggml_backend_buffer_deleter, ggml_backend_buffer_t, alloc_tensor_range(), ggml_backend_buffer_t, free_buffers(), ggml_backend_alloc_ctx_tensors_from_buft_impl(), ggml_tallocr_alloc(), ggml_tallocr_new() (+32 more)
...
### Community 56 - "ggml.c"
Cohesion: 0.02
Nodes (218): ggml_abort_callback_t, GGML_API, ggml_fp16_t, ggml_log_callback, ggml_abs(), ggml_abs_inplace(), ggml_add1(), ggml_add1_impl() (+210 more)
...
### Community 59 - "meeting_list_view_test.dart"
Cohesion: 0.10
...
Cohesion: 0.05
Nodes (35): AudioRecorder, _DeterministicPcmAudioCapture, DeviceRecordingStorageCapacityProvider, dispose, hasPermission, meettracePcmRecordConfig, pause, _recorder (+27 more)

### Community 62 - "whisper_asr_engine_factory_test.dart"
Cohesion: 0.04
Nodes (50): changes, inspect, main, _modelRoot, _prepareDelaySeconds, SqfliteModelUsageLeaseRepository, ModelUsageLeaseRepository, _MemoryInstallations (+42 more)
...
Cohesion: 0.11
Nodes (17): dart:async, ../../../../../domain/models/meeting.dart, _appDatabase, _changes, delete, dispose, getById, listAll (+9 more)
...
Cohesion: 0.03
Nodes (77): mt_whisper_destroy(), mt_whisper_transcribe(), mt_whisper_vad_segment_samples(), aheads_masks_free(), whisper_vad_params, cs_to_samples(), dft(), fft() (+69 more)
...
### Community 73 - "ggml_compute_forward_flash_attn_back_f32"
Cohesion: 0.09
Nodes (29): ggml_compute_forward_cross_entropy_loss_back_f32(), ggml_compute_forward_flash_attn_back_f32(), ggml_compute_forward_flash_attn_ext_tiled(), ggml_compute_forward_gated_delta_net_one_chunk(), ggml_compute_forward_get_rows_f32(), ggml_compute_forward_norm_f32(), ggml_compute_forward_rms_norm_f32(), ggml_compute_forward_soft_max_ext_back_f32() (+21 more)

### Community 74 - "ggml-backend-reg.cpp"
Cohesion: 0.04
Nodes (50): gguf_context, ggml_backend, ggml_backend_buffer, ggml_backend_buffer_type, ggml_backend_dev_caps, async, buffer_from_host_ptr, events (+42 more)
...
Cohesion: 0.05
Nodes (36): RecordingState, RecordingStateTransition, package:meettrace/domain/use_cases/manage_recording_session.dart, package:meettrace/ui/features/meetings/view_models/recording/recording_session_view_model.dart, audioLevelChanges, _audioLevels, canFinalize, close (+28 more)

### Community 78 - "android_proc_asr_device_risk_monitor.dart"
Cohesion: 0.06
Nodes (30): _SupportedRiskMonitor, AndroidProcAsrDeviceRiskMonitor, AsrRiskTextReader, AsrThermalPathLister, changes, _constrainedMemoryBytes, _deviceSupport, inspect (+22 more)
...
Cohesion: 0.04
Nodes (50): dart:convert, 0, _compareVersions, currentAppVersion, leftParts, ModelManifestParser, normalized, parse (+42 more)

### Community 81 - "vec.h"
Cohesion: 0.04
Nodes (74): ggml_set_f32(), ggml_set_i32(), ggml_compute_forward_flash_attn_ext_f16_one_chunk(), ggml_compute_forward_geglu_f32(), ggml_compute_forward_geglu_quick_f32(), ggml_compute_forward_out_prod_f32(), ggml_fp16_t, ggml_gelu_f32() (+66 more)

### Community 82 - "unary-ops.cpp"
Cohesion: 0.05
Nodes (57): Op, ggml_tensor, buffer, data, extra, flags, name, nb (+49 more)
...
Cohesion: 0.06
Nodes (31): createBaseDirectories, databaseDirectory, databasePath, forApplication, meetingAudioCheckpointNextPath, meetingAudioCheckpointPath, meetingAudioCheckpointPreviousPath, meetingAudioDirectory (+23 more)
...
### Community 90 - "whisper_layer_encoder"
Cohesion: 0.12
...
Cohesion: 0.04
Nodes (67): block_q4_0x4, block_q4_0x8, block_q8_0x16, block_q8_0x4, ggml_quantize_mat_q8_K_4x8(), block_iq4_nl, block_mxfp4, block_q2_K (+59 more)

### Community 92 - "Exception"
Cohesion: 0.06
Nodes (33): Exception, WhisperAdapterException, BundledModelPreparationException, _PreparationFailure, ModelDownloadCanceledException, available, code, endMs (+25 more)

### Community 93 - "run_final_transcription.dart"
Cohesion: 0.08
Nodes (23): _PendingTranscriptionRunner, _UnavailableTranscriptionRunner, FinalTranscriptionRunner, code, engineFactory, _errorCode, FinalTranscriptionService, FinalTranscriptionSnapshotIdFactory (+15 more)
...
### Community 95 - "ggml_backend_meta_get_split_state"
Cohesion: 0.20
Nodes (17): ggml_backend_meta_buffer_get_tensor(), ggml_backend_meta_buffer_init_tensor_impl(), ggml_backend_meta_buffer_n_bufs(), ggml_backend_meta_buffer_set_tensor(), ggml_backend_meta_buffer_simple_tensor(), ggml_backend_meta_get_split_state(), ggml_backend_meta_get_tensor_async(), ggml_backend_meta_set_tensor_async() (+9 more)
...
### Community 97 - "ggml_cgraph"
Cohesion: 0.18
Nodes (11): ggml_cgraph, grad_accs, grads, leafs, n_leafs, n_nodes, nodes, order (+3 more)

### Community 98 - "List"
Cohesion: 0.05
Nodes (41): AsrDeviceRiskState get, AsrInstallationType, AsrModelDescriptor, AsrModelTier, capabilities, displayName, installationType, modelId (+33 more)

### Community 99 - "ggml-backend.cpp"
Cohesion: 0.06
Nodes (94): ggml_backend_eval_callback, ggml_backend_buffer_type_t, ggml_backend_dev_t, ggml_backend_event_t, ggml_backend_graph_plan_t, ggml_backend_sched_t, ggml_backend_t, ggml_guid_t (+86 more)
...
Cohesion: 0.05
Nodes (59): ffi.Struct, Metrics, mt_whisper_config_v1, mt_whisper_vad_config_v1, atomic_bool, vector, whisper_vad_params, mt_whisper_cancel() (+51 more)
...
Cohesion: 0.08
Nodes (47): pair, vector, decode_utf8(), log_mel_spectrogram_worker_thread(), map_processed_to_original_time(), tokenize(), whisper_compute_logprobs(), whisper_compute_probs() (+39 more)
...
Cohesion: 0.10
Nodes (52): ggml_backend_buffer_init(), ggml_backend_buffer_reset(), ggml_backend_buft_alloc_buffer(), ggml_backend_buffer_t, ggml_backend_buffer_type_t, ggml_backend_dev_t, ggml_backend_t, ggml_guid_t (+44 more)
...
### Community 123 - "gguf_get_n_tensors"
Cohesion: 0.29
...
Cohesion: 0.05
Nodes (65): atomic_flag, atomic_flag_clear(), atomic_flag_test_and_set(), atomic_bool, cpu_set_t, ggml_bf16_t, ggml_fp16_t, ggml_backend_cpu_get_features() (+57 more)

### Community 127 - "ggml-impl.h"
Cohesion: 0.04
Nodes (78): ggml_bitset_t, GGML_NORETURN, initializer_list, ggml_backend_meta_graph_compute(), ggml_cpu_try_fuse_ops(), ggml_abort(), ggml_build_backward_expand(), ggml_build_forward_impl() (+70 more)
...
Cohesion: 0.07
Nodes (59): ggml_opt_context_t, ggml_opt_dataset_t, ggml_opt_epoch_callback, ggml_opt_result_t, ggml_context, ggml_time_us(), GGML_API, ggml_backend_buffer_t (+51 more)
...
### Community 133 - "ggml_barrier"
Cohesion: 0.14
Nodes (25): from_float(), atomic_fetch_add_explicit(), ggml_backend_cpu_device_supports_op(), ggml_barrier(), ggml_compute_forward_mul_mat(), ggml_compute_forward_mul_mat_id(), ggml_get_type_traits_cpu(), ggml_is_numa() (+17 more)
...
Cohesion: 0.11
Nodes (48): add_allocated_tensor(), aligned_offset(), ggml_backend_buffer_type_t, ggml_gallocr_t, get_node_buffer_id(), ggml_backend_alloc_ctx_tensors_from_buft_size(), ggml_buffer_address_less(), ggml_dyn_tallocr_alloc() (+40 more)
...
### Community 142 - "ggml_is_contiguous"
Cohesion: 0.05
Nodes (91): buft_list_t, ggml_op, ggml_backend_cpu_buffer_type(), ggml_tensor, ggml_acc(), ggml_acc_impl(), ggml_acc_inplace(), ggml_acc_or_set() (+83 more)
...
Cohesion: 0.11
Nodes (44): apply_binary_op(), get_thread_range(), pair, ggml_compute_forward_acc_f32(), ggml_compute_forward_add1(), ggml_compute_forward_add1_bf16_bf16(), ggml_compute_forward_add1_bf16_f32(), ggml_compute_forward_add1_f16_f16() (+36 more)
...
Cohesion: 0.67
Nodes (4): ggml_quantize_free(), ggml_quantize_init(), ggml_critical_section_end(), ggml_critical_section_start()
...
Cohesion: 0.05
Nodes (44): backend_config, ggml_backend_buffer_ptr, ggml_backend_comm_allreduce_tensor_t, ggml_backend_meta_split_state, ggml_context_ptr, ggml_init_params, mem_buffer, mem_size (+36 more)
...
### Community 160 - "_"
Cohesion: 0.03
Nodes (87): asr_model.dart, AsrEngineMetrics get, AsrModelDescriptor get, _PreviewAsrEngine, ../../../../../domain/models/app_failure.dart, context, create, _createAdvanced (+79 more)
...
Cohesion: 0.10
Nodes (28): bind_ai_thread(), cpu::extra_buffer_type, cpu::tensor_traits, ggml_backend_buffer_t, ggml_backend_buffer_type_t, ggml_backend_dev_t, ggml_compute_params, ggml_tensor (+20 more)

### Community 168 - "ggml-quants.c"
Cohesion: 0.08
Nodes (28): block_iq1_m, block_iq1_s, block_iq2_xs, block_iq2_xxs, block_iq3_s, block_iq3_xxs, block_q8_0, block_q8_K (+20 more)

### Community 169 - "x86/repack.cpp"
Cohesion: 0.08
Nodes (34): ggml_gemm_q4_0_8x8_q8_0(), ggml_gemv_q4_0_8x8_q8_0(), ggml_gemm_q4_0_8x8_q8_0(), ggml_gemv_q4_0_8x8_q8_0(), __avx512_f32cx8x2_load(), __avx512_repeat_f32cx16_load(), __avx_f32cx8_load(), __avx_rearranged_f32cx8_load() (+26 more)
...
Cohesion: 0.07
Nodes (52): GGML_KLEIDIAI_MAX_KERNEL_SLOTS, align_up(), ceil_div_size(), array, cpu::extra_buffer_type, cpu::tensor_traits, ggml_backend_buffer_t, ggml_backend_buffer_type_t (+44 more)
...
Cohesion: 0.07
Nodes (31): A, B, id, mt19937, whisper_decoder, completed, failed, grammar (+23 more)
...
Cohesion: 0.05
Nodes (28): aarch64_features, has_dotprod, has_fp16_va, has_i8mm, has_sme, has_sve, has_sve2, riscv64_features (+20 more)
...
Cohesion: 0.09
Nodes (38): get_signal_energy(), sample_to_timestamp(), should_split_on_word(), timestamp_to_sample(), utf8_len(), voice_length(), whisper_batch_prep_legacy(), whisper_decode() (+30 more)

### Community 274 - "hugetlb_1g_region"
Cohesion: 0.40
Nodes (5): hugetlb_1g_region, dma_addr, flags, reserved, size

### Community 276 - "ggml_map_custom1_impl"
Cohesion: 0.83
...
### Community 392 - "ggml_nbytes"
Cohesion: 0.08
Nodes (73): function, ggml_backend_t, ggml_backend_alloc_ctx_tensors(), ggml_backend_alloc_ctx_tensors_from_buft(), ggml_backend_graph_copy(), ggml_backend_sched_alloc_graph(), ggml_backend_tensor_get(), ggml_backend_tensor_get_2d() (+65 more)
...
Cohesion: 0.10
Nodes (34): atomic_int, LONG, memory_order, atomic_fetch_add(), atomic_load(), atomic_load_explicit(), atomic_store(), atomic_store_explicit() (+26 more)
...
Cohesion: 0.13
Nodes (27): ggml_backend_meta_get_split_state_t, ggml_backend_dev_description(), ggml_backend_dev_init(), ggml_backend_dev_name(), ggml_backend_dev_type(), ggml_backend_meta_device, ggml_backend_meta_device_context, description (+19 more)
...
Cohesion: 0.16
Nodes (13): binary_op(), ggml_compute_params, ggml_tensor, ggml_compute_forward_add_non_quantized(), ggml_compute_forward_div(), ggml_compute_forward_mul(), ggml_compute_forward_sub(), ggml_compute_forward_add() (+5 more)
...
Cohesion: 0.11
Nodes (19): ggml_compute_forward_conv_2d_dw(), ggml_compute_forward_conv_2d_dw_cwhn(), ggml_compute_forward_conv_2d_dw_whcn(), ggml_conv_2d_dw_params, batch, channels, dilation_x, dilation_y (+11 more)
...
Cohesion: 0.11
Nodes (30): block_q3_K, quantize_row_q2_K(), quantize_row_q3_K(), quantize_row_q4_K(), quantize_row_q5_K(), block_q2_K, block_q4_K, block_q5_K (+22 more)
...
### Community 493 - "ggml_row_size"
Cohesion: 0.23
Nodes (10): block_tq1_0, ggml_compute_forward_mul_mat_one_chunk(), quantize_row_tq1_0(), ggml_compute_params, ggml_tensor, tensor_traits, ggml_row_size(), dequantize_row_tq1_0() (+2 more)

### Community 494 - "ggml_quantize_chunk"
Cohesion: 0.14
Nodes (18): block_iq2_s, ggml_quantize_chunk(), ggml_quantize_requires_imatrix(), dequantize_row_iq2_s(), iq1_find_best_neighbour2(), iq2_data_index(), iq2_find_best_neighbour(), iq2xs_free_impl() (+10 more)
...
## Knowledge Gaps
- **4435 isolated node(s):** `schemaVersion`, `minAppVersion`, `models`, `_MeetingFlowFixture`, `_modelAsset` (+4430 more)
...
- **Why does `_string` connect `_string` to `use_cases/evaluate_alpha_release.dart`, `cpuid_x86`, `ggml_nbytes`, `whisper_model`, `vector`, `whisper_full_with_state`, `whisper_state`, `whisper_vad_model`, `ggml_backend_meta_context`, `gguf_reader`, `make_buft_list`, `ggml-cpu.cpp`, `ggml_backend_load_best`, `gguf_set_kv`, `gguf.cpp`, `x86/cpu-feats.cpp`, `spine_mem_pool.cpp`, `whisper_context`, `data`, `whisper.cpp`, `ggml-backend-reg.cpp`, `whisper_vad_context`, `size`, `ggml_backend_meta_get_split_state`, `meettrace_whisper.cpp`, `vector`, `ggml-backend-meta.cpp`?**
  _High betweenness centrality (0.186) - this node is a cross-community bridge._
- **Why does `cpuid_x86` connect `cpuid_x86` to `_string`, `x86/cpu-feats.cpp`, `ggml_backend_cpu_x86_score`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `DomainInvariantViolation` connect `sqflite_repositories_test.dart` to `meeting_list_view_model_test.dart`, `Exception`, `whisper_asr_engine_factory_test.dart`?**
