...
## Corpus Check
- 474 files · ~706,281 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9326 nodes · 17602 edges · 520 communities (345 shown, 175 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 2129 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8336f49d`
...
## Communities (520 total, 175 thin omitted)
...
Cohesion: 0.09
Nodes (21): BundledModelPreparationService, ModelAssetSource, FlutterModelAssetSource, package:meettrace/data/services/models/bundled_model_preparation_service.dart, assets, bytesByUrl, current, _descriptor (+13 more)
...
Cohesion: 0.04
Nodes (46): dart:typed_data, _copyAsset, data, main, _modelAsset, package:meettrace/data/services/asr/whisper_base_standard_asr_engine.dart, package:meettrace/data/services/asr/whisper/whisper_adapter.dart, package:meettrace/data/services/asr/whisper/whisper_recognizer_profiles.dart (+38 more)
...
Cohesion: 0.03
Nodes (74): StartupRecoveryService, DomainInvariantViolation, message, toString, TranscriptSnapshotStatus, ResolveMeetingModelSelection, package:meettrace/data/repositories/sqflite_diarization_preference_repository.dart, package:meettrace/data/repositories/sqflite_meeting_repository.dart (+66 more)
...
Cohesion: 0.02
Nodes (85): AsrDeviceRiskState get, AsrEngineMetrics get, WhisperAsrEngineFactory, AsrInstallationType, AsrModelDescriptor, AsrModelTier, capabilities, displayName (+77 more)

### Community 19 - "ggml_dup_tensor"
Cohesion: 0.04
Nodes (73): ggml_custom1_op_t, ggml_custom2_op_t, ggml_custom3_op_t, ggml_custom_op_t, ggml_acc(), ggml_acc_impl(), ggml_acc_inplace(), ggml_add_id() (+65 more)

### Community 20 - "meeting_detail_view_model_test.dart"
Cohesion: 0.02
Nodes (114): >, _PendingTranscriptionRunner, _PreviewSummaryRepository, _UnavailableTranscriptionRunner, SqfliteProcessingTaskRepository, SqfliteSummaryRepository, MeetingState, MeetingStateTransition (+106 more)
...
Cohesion: 0.03
Nodes (74): asr_engine.dart, ../../../domain/ports/summary_generation.dart, capability, generate, UnavailableSummaryGenerationService, Meeting, TranscriptSnapshot, FinalTranscriptionProgressCallback (+66 more)

### Community 26 - "Exception"
Cohesion: 0.07
Nodes (29): Directory, Exception, WhisperAdapterException, BundledModelPreparationException, _PreparationFailure, DownloadableModelException, ModelDownloadCanceledException, SpeakerDiarizationException (+21 more)
...
Cohesion: 0.02
Nodes (81): accept, build, check, _chunkSequence, _controller, _copyAsset, create, createState (+73 more)
...
Cohesion: 0.05
Nodes (44): ../../../../domain/models/asr_model_registry.dart, ../../../../../domain/models/meeting.dart, ../../../domain/models/model_usage_lease.dart, ../../../../../domain/models/processing_task.dart, _appDatabase, _enabledKey, getEnabled, setEnabled (+36 more)

### Community 33 - "dart:async"
Cohesion: 0.08
Nodes (22): dart:async, _appDatabase, _changes, deleteAndDeactivate, dispose, getActiveVersion, listAll, row (+14 more)
...
Cohesion: 0.08
Nodes (23): AudioLevel, _PreviewRecordingService, Duration get, ReliableRecordingService, audioLevelChanges, canFinalize, cause, code (+15 more)
...
### Community 54 - "ggml_get_op_params_i32"
Cohesion: 0.12
Nodes (24): ggml_get_n_tasks(), ggml_graph_plan(), ggml_compute_forward_concat(), ggml_compute_forward_concat_any(), ggml_compute_forward_concat_f16(), ggml_compute_forward_concat_f32(), ggml_compute_forward_concat_i8(), ggml_compute_forward_geglu() (+16 more)
...
### Community 56 - "ggml.c"
Cohesion: 0.03
Nodes (96): ggml_fp16_t, ggml_log_callback, ggml_abs_inplace(), ggml_add1(), ggml_add1_impl(), ggml_add1_inplace(), ggml_add_cast(), ggml_add_cast_impl() (+88 more)
...
Cohesion: 0.08
Nodes (25): actions, _applyInstallations, cancelAdvanced, _defaultModelId, deleteAdvanced, dispose, _disposed, downloadAdvanced (+17 more)
...
Cohesion: 0.03
Nodes (66): changes, inspect, main, _modelRoot, _prepareDelaySeconds, SqfliteModelUsageLeaseRepository, AndroidProcAsrDeviceRiskMonitor, ModelUsageLeaseRepository (+58 more)
...
Cohesion: 0.05
Nodes (45): SqfliteModelInstallationRepository, SqfliteModelPreferenceRepository, ActiveModelInstallationRepository, ModelPreferenceRepository, package:meettrace/data/repositories/sqflite_model_preference_repository.dart, package:meettrace/domain/models/asr_model_registry.dart, package:meettrace/domain/models/meeting_readiness.dart, package:meettrace/domain/ports/asr_engine.dart (+37 more)
...
### Community 68 - "recording_device_readiness_probe_test.dart"
Cohesion: 0.10
...
Cohesion: 0.03
Nodes (65): ggml_log_level, mt_whisper_destroy(), mt_whisper_transcribe(), ggml_n_dims(), byteswap(), byteswap_tensor_data(), ggml_log_callback, T (+57 more)
...
### Community 72 - "recording_checkpoint_store.dart"
Cohesion: 0.11
Nodes (19): delete, fromJson, hashCode, JsonRecordingCheckpointStore, layout, load, meetingId, operator (+11 more)

### Community 73 - "ggml_compute_forward_flash_attn_ext_tiled"
Cohesion: 0.10
Nodes (26): ggml_compute_forward_flash_attn_ext_tiled(), ggml_compute_forward_swiglu_f32(), simd_gemm(), ggml_bf16_t, ggml_float, exp_ps_sve(), ggml_silu_f32(), ggml_v_expf() (+18 more)
...
### Community 76 - "whisper_full_with_state"
Cohesion: 0.09
...
### Community 77 - "dart:io"
Cohesion: 0.08
Nodes (21): dart:io, package:ffigen/ffigen.dart, bindings, generator, header, includedFunctions, libclangPath, main (+13 more)
...
### Community 79 - "size"
Cohesion: 0.14
Nodes (20): mt_whisper_vad_segment_samples(), whisper_vad_params, cs_to_samples(), samples_to_cs(), to_timestamp(), whisper_full(), whisper_full_n_segments_from_state(), whisper_full_n_tokens() (+12 more)
...
### Community 81 - "vec.h"
Cohesion: 0.04
Nodes (75): ggml_set_f32(), ggml_set_i32(), ggml_compute_forward_geglu_f32(), ggml_compute_forward_geglu_quick_f32(), ggml_compute_forward_out_prod_f32(), ggml_compute_forward_repeat_back_f32(), ggml_fp16_t, ggml_gelu_f32() (+67 more)
...
Cohesion: 0.07
Nodes (26): DatabaseFactory, createBaseDirectories, databaseDirectory, databasePath, forApplication, meetingAudioCheckpointNextPath, meetingAudioCheckpointPath, meetingAudioCheckpointPreviousPath (+18 more)
...
Cohesion: 0.07
Nodes (27): _PreviewMeetingRepository, _PreviewMeetingRepository, MeetingRepository, package:meettrace/domain/use_cases/revise_final_transcript.dart, _MeetingRepository, _MeetingRepository, _Meetings, _InMemoryMeetingRepository (+19 more)

### Community 88 - "whisper_vad_context"
Cohesion: 0.10
Nodes (20): ggml_backend_sched_t, whisper_sched, sched, whisper_vad_context, backends, buffer, c_state, ctx_buf (+12 more)

### Community 89 - "List"
Cohesion: 0.02
Nodes (84): AnimatedContainer, _PreviewMeetingFileDeletionService, Completer, FTappable, MeetingDirectoryDeletionService, alpha, _byId, defaultModel (+76 more)
...
Cohesion: 0.02
Nodes (120): block_q4_0x4, block_q4_0x8, block_q8_0x16, block_q8_0x4, ggml_quantize_mat_q8_K_4x8(), block, d, block_iq4_nlx16 (+112 more)
...
### Community 94 - ".compute_forward_qx"
Cohesion: 0.15
...
Cohesion: 0.09
Nodes (29): ggml_abs(), ggml_ceil(), ggml_compute_backward(), ggml_elu(), ggml_exp(), ggml_expm1(), ggml_floor(), ggml_gelu_erf() (+21 more)
...
### Community 97 - "ggml_backend_load_best"
Cohesion: 0.23
...
### Community 98 - "meeting_directory_deletion_service.dart"
Cohesion: 0.11
...
Cohesion: 0.05
Nodes (103): ggml_backend_buffer_t, ggml_backend_buffer_type_t, ggml_backend_dev_t, ggml_backend_event_t, ggml_backend_graph_plan_t, ggml_backend_sched_t, ggml_backend_t, ggml_guid_t (+95 more)
...
Cohesion: 0.07
Nodes (27): android_proc_asr_device_risk_monitor.dart, dart:math, ../../../../../domain/models/recording.dart, Duration, AsrRiskPlatform, changes, createPlatformAsrDeviceRiskMonitor, _currentPlatform (+19 more)

### Community 106 - "check_meeting_readiness.dart"
Cohesion: 0.11
Nodes (18): _PreviewMeetingReadinessChecker, _ReadyMeetingChecker, DeviceRecordingReadinessProbe, check, CheckMeetingReadinessUseCase, device, freeBytes, installations (+10 more)
...
### Community 111 - "class"
Cohesion: 0.06
Nodes (35): @pragma, class, ../../../../../domain/use_cases/check_meeting_readiness.dart, flutter_foreground_recording_lifecycle.dart, DeviceRecordingStorageCapacityProvider, freeSpace, getFreeBytes, meetTraceRecordingForegroundCallback (+27 more)

### Community 112 - "_string"
Cohesion: 0.04
Nodes (65): ffi.Struct, _string, Metrics, mt_whisper_config_v1, mt_whisper_vad_config_v1, atomic_bool, vector, whisper_vad_params (+57 more)
...
Cohesion: 0.07
Nodes (50): pair, vector, decode_utf8(), log_mel_spectrogram(), log_mel_spectrogram_worker_thread(), map_processed_to_original_time(), tokenize(), whisper_compute_logprobs() (+42 more)

### Community 116 - "package:flutter/services.dart"
Cohesion: 0.09
Nodes (18): AssetBundle, bundled_model_preparation_service.dart, CachingAssetBundle, bundle, load, appSystemUiOverlayStyle, base, copyWith (+10 more)

### Community 117 - "ggml_compute_forward_flash_attn_back_f32"
Cohesion: 0.17
Nodes (18): ggml_compute_forward_flash_attn_back_f32(), ggml_compute_forward_flash_attn_ext_f16_one_chunk(), ggml_compute_forward_gated_delta_net_one_chunk(), ggml_compute_forward_get_rows_f32(), ggml_compute_forward_norm_f32(), ggml_compute_forward_scale_f32(), ggml_compute_forward_soft_max_ext_back_f32(), ggml_compute_forward_soft_max_f32() (+10 more)

### Community 118 - "package:path/path.dart"
Cohesion: 0.11
Nodes (16): downloadable_model_service.dart, ModelFileDownloader, download, HttpModelFileDownloader, requireHttps, ModelManifestEntry, package:meettrace/data/services/models/model_file_verifier.dart, package:meettrace/data/services/models/model_manifest_parser.dart (+8 more)

### Community 119 - "app_database.dart"
Cohesion: 0.08
Nodes (23): Database?, _bytesPerPcm16Sample, bytesWritten, channelCount, elapsed, isComplete, _minimumCompleteRatio, RecordingContinuityMetrics (+15 more)

### Community 120 - "ggml-backend-meta.cpp"
Cohesion: 0.05
Nodes (88): ggml_backend_buffer_ptr, ggml_backend_meta_get_split_state_t, ggml_backend_meta_split_state, ggml_backend_buffer_t, ggml_backend_buffer_type_t, ggml_backend_dev_t, ggml_backend_t, ggml_guid_t (+80 more)

### Community 121 - "arm/repack.cpp"
Cohesion: 0.04
Nodes (75): quantize_row_q8_0(), quantize_row_q8_1(), int16x8_t, decode_q_Kx8_6bit_scales(), ggml_gemm_iq4_nl_4x4_q8_0(), ggml_gemm_mxfp4_4x4_q8_0(), ggml_gemm_q4_0_4x4_q8_0(), ggml_gemm_q4_0_4x8_q8_0() (+67 more)
...
Cohesion: 0.04
Nodes (69): ggml_bitset_t, initializer_list, ggml_cpu_try_fuse_ops(), ggml_build_backward_expand(), ggml_can_fuse_subgraph_ext(), ggml_graph_cpy(), ggml_graph_get_grad(), ggml_graph_get_grad_acc() (+61 more)
...
Cohesion: 0.07
Nodes (55): ggml_opt_context_t, ggml_opt_dataset_t, ggml_opt_epoch_callback, ggml_opt_result_t, GGML_API, ggml_backend_buffer_t, ggml_backend_sched_t, ggml_tensor (+47 more)
...
### Community 131 - "_"
Cohesion: 0.10
Nodes (21): AsrModelDescriptor get, _, acceptAudio, cancel, _core, descriptor, deviceRisk, deviceRisks (+13 more)
...
Cohesion: 0.08
Nodes (56): from_float(), atomic_fetch_add_explicit(), ggml_backend_cpu_device_supports_op(), ggml_barrier(), ggml_compute_forward_mul_mat(), ggml_compute_forward_mul_mat_id(), ggml_compute_forward_mul_mat_one_chunk(), ggml_get_type_traits_cpu() (+48 more)

### Community 134 - "platform_download_preflight_providers.dart"
Cohesion: 0.13
...
Cohesion: 0.08
Nodes (66): add_allocated_tensor(), aligned_offset(), alloc_tensor_range(), ggml_backend_buffer_t, ggml_backend_buffer_type_t, ggml_gallocr_t, free_buffers(), get_node_buffer_id() (+58 more)
...
Cohesion: 0.09
Nodes (49): get_thread_range(), pair, ggml_compute_forward_acc_f32(), ggml_compute_forward_add1(), ggml_compute_forward_add1_bf16_bf16(), ggml_compute_forward_add1_bf16_f32(), ggml_compute_forward_add1_f16_f16(), ggml_compute_forward_add1_f16_f32() (+41 more)
...
### Community 158 - "manage_recording_session.dart"
Cohesion: 0.13
...
Cohesion: 0.06
Nodes (58): ggml_threadpool_t, ggml_guid_t, ggml_abort_callback, ggml_backend_buffer_t, ggml_backend_buffer_type_t, ggml_backend_dev_t, ggml_backend_graph_plan_t, ggml_backend_reg_t (+50 more)

### Community 164 - "model_file_verifier.dart"
Cohesion: 0.14
...
### Community 165 - "ggml_set_op_params_f32"
Cohesion: 0.14
Nodes (14): ggml_arange(), ggml_fill(), ggml_fill_impl(), ggml_fill_inplace(), ggml_group_norm(), ggml_group_norm_impl(), ggml_group_norm_inplace(), ggml_l2_norm() (+6 more)
...
Cohesion: 0.08
Nodes (29): block_iq1_m, block_iq1_s, block_iq2_xs, block_iq2_xxs, block_iq3_s, block_iq3_xxs, quantize_row_q4_1(), block_q4_1 (+21 more)

### Community 169 - "x86/repack.cpp"
Cohesion: 0.08
Nodes (34): ggml_gemm_q4_0_8x8_q8_0(), ggml_gemm_q4_0_8x8_q8_0(), __avx512_f32cx8x2_load(), __avx512_repeat_f32cx16_load(), __avx_f32cx8_load(), __avx_rearranged_f32cx8_load(), __avx_repeat_f32cx8_load(), ggml_fp16_t (+26 more)
...
Cohesion: 0.08
Nodes (36): gguf_add_tensor(), gguf_find_key(), gguf_find_tensor(), gguf_get_arr_str(), gguf_get_arr_type(), gguf_get_key(), gguf_get_kv_type(), gguf_get_n_kv() (+28 more)
...
Cohesion: 0.05
Nodes (50): ggml_add_rel_pos(), ggml_add_rel_pos_impl(), ggml_add_rel_pos_inplace(), ggml_argsort(), ggml_argsort_top_k(), ggml_calc_conv_output_size(), ggml_calc_conv_transpose_output_size(), ggml_calc_pool_output_size() (+42 more)
...
Cohesion: 0.06
Nodes (38): A, B, id, mt19937, whisper_decoder, completed, failed, grammar (+30 more)
...
### Community 194 - "whisper_kv_cache"
Cohesion: 0.15
Nodes (13): ggml_backend_buffer_t, whisper_aheads_masks, buffer, ctx, m, whisper_kv_cache, buffer, cells (+5 more)

### Community 195 - "resolve_meeting_model_selection.dart"
Cohesion: 0.17
...
### Community 197 - "aarch64_features"
Cohesion: 0.20
...
Cohesion: 0.06
Nodes (30): app_database.dart, ../audio/recording_checkpoint_store.dart, durable_file_committer.dart, AppFileLayout, commit, DurableFileCommitException, DurableFileCommitter, message (+22 more)
...
Cohesion: 0.08
Nodes (15): riscv64_features, has_rvv, s390x_features, has_nnpa, has_vxe2, extra_buffer_type, get_tensor_traits, supports_op (+7 more)

### Community 217 - "size"
Cohesion: 0.10
Nodes (26): T, vector, gguf_buffer_reader, data, size, gguf_get_arr_data(), gguf_get_arr_n(), gguf_get_meta_data() (+18 more)
...
### Community 260 - "ggml_backend_meta_split_state"
Cohesion: 0.40
Nodes (5): ggml_backend_meta_split_state, axis, n_segments, ne, nr

### Community 272 - "ggml_init_params"
Cohesion: 0.40
Nodes (4): ggml_init_params, mem_buffer, mem_size, no_alloc

### Community 273 - "ggml_nbytes"
Cohesion: 0.11
Nodes (36): ggml_backend_eval_callback, ggml_backend_buffer_copy_tensor(), ggml_backend_compare_graph_backend(), ggml_backend_graph_compute(), ggml_backend_graph_compute_async(), ggml_backend_graph_copy_free(), ggml_backend_sched_alloc_graph(), ggml_backend_sched_alloc_splits() (+28 more)

### Community 274 - ".supports_op"
Cohesion: 0.29
...
### Community 286 - "ggml_print_backtrace"
Cohesion: 0.33
...
### Community 309 - "AsrDeviceRiskMonitor"
Cohesion: 0.33
Nodes (6): _SupportedRiskMonitor, PortableAsrDeviceRiskMonitor, AsrDeviceRiskMonitor, AsrDeviceRiskState, _SupportedRiskMonitor, _RiskMonitor
...
### Community 333 - "ggml_graph_compute_check_for_work"
Cohesion: 0.40
Nodes (6): atomic_thread_fence(), ggml_graph_compute_check_for_work(), ggml_graph_compute_poll_for_work(), ggml_graph_compute_thread_ready(), ggml_graph_compute_thread_sync(), ggml_thread_cpu_relax()

### Community 336 - "ime_kernels.h"
Cohesion: 0.12
Nodes (10): nrow_block_q3_k, hmask, qs, scales, scales16, nrow_block_q5_1, qh, qs (+2 more)
...
### Community 345 - "ggml_kleidiai_select_kernels"
Cohesion: 0.47
...
Cohesion: 0.09
Nodes (53): ggml_context, ggml_acc_or_set(), ggml_add(), ggml_add1_or_set(), ggml_add_impl(), ggml_add_inplace(), ggml_add_or_set(), ggml_build_forward_expand() (+45 more)
...
Cohesion: 0.13
Nodes (27): atomic_int, LONG, memory_order, atomic_fetch_add(), atomic_load(), atomic_load_explicit(), atomic_store(), atomic_store_explicit() (+19 more)
...
### Community 413 - "quantize_row_tq1_0_ref"
Cohesion: 0.40
...
Cohesion: 0.15
Nodes (13): gguf_reader_callback_t, ggml_set_no_alloc(), gguf_free(), gguf_init_from_buffer(), gguf_init_from_callback(), gguf_init_from_reader(), gguf_read_emplace_helper(), gguf_reader (+5 more)
...
Cohesion: 0.17
Nodes (23): ggml_backend_reg_t, ggml_backend_dev_init(), ggml_backend_dev_name(), ggml_backend_dev_type(), ggml_backend_reg_dev_count(), ggml_backend_reg_dev_get(), ggml_backend_reg_get_proc_address(), ggml_backend_reg_name() (+15 more)
...
### Community 421 - "ggml_quantize_init"
Cohesion: 0.24
Nodes (9): mutex_, ggml_quantize_free(), ggml_quantize_init(), iq2xs_free_impl(), iq3_data_index(), iq3xs_free_impl(), iq3xs_init_impl(), ggml_critical_section_end() (+1 more)

### Community 422 - "hugetlb_1g_region"
Cohesion: 0.40
Nodes (5): hugetlb_1g_region, dma_addr, flags, reserved, size

### Community 424 - "benchmarks/evaluate_alpha_release.dart"
Cohesion: 0.08
Nodes (21): dart:convert, databaseBytes, DiagnosticReport, fields, freeBytes, LocalStorageUsage, meetingBytes, modelBytes (+13 more)
...
### Community 426 - "operator()"
Cohesion: 0.67
Nodes (3): ALWAYS_INLINE, Func, operator()()

### Community 427 - "ggml_opt_build"
Cohesion: 0.08
Nodes (66): buft_list_t, function, ggml_op, ggml_backend_t, ggml_backend_alloc_ctx_tensors(), ggml_backend_alloc_ctx_tensors_from_buft(), ggml_backend_buffer_free(), ggml_backend_free() (+58 more)

### Community 428 - ".compute_forward"
Cohesion: 0.16
Nodes (15): apply_binary_op(), binary_op(), ggml_compute_params, ggml_tensor, ggml_compute_forward_add_non_quantized(), ggml_compute_forward_div(), ggml_compute_forward_mul(), ggml_compute_forward_sub() (+7 more)
...
### Community 448 - "ggml_backend_feature"
Cohesion: 0.67
...
### Community 463 - "nrow_block_mxfp4"
Cohesion: 0.29
Nodes (8): nrow_block_mxfp4, e, qh, qs, convert_mxfp4_to_5bit(), block_mxfp4, make_block_mxfp4x32(), repack_mxfp4_to_mxfp4_32_bl()
...
### Community 490 - "local_data_control_service.dart"
Cohesion: 0.09
Nodes (21): _PreviewInstallations, device_free_space_service.dart, ../../../../domain/models/data_control.dart, ../../../../domain/ports/local_data_control.dart, buildDiagnostics, freeSpace, installations, layout (+13 more)

### Community 491 - "nearest_int"
Cohesion: 0.16
Nodes (18): block_q3_K, quantize_row_q2_K(), quantize_row_q3_K(), block_q2_K, dequantize_row_q2_K(), dequantize_row_q3_K(), make_q3_quants(), make_qkx1_quants() (+10 more)
...
## Knowledge Gaps
- **4331 isolated node(s):** `schemaVersion`, `minAppVersion`, `models`, `_MeetingFlowFixture`, `_modelAsset` (+4326 more)
...
- **Why does `_string` connect `_string` to `use_cases/evaluate_alpha_release.dart`, `cpuid_x86`, `whisper_model`, `vector`, `whisper_state`, `whisper_vad_model`, `ggml_backend_meta_context`, `gguf_init_from_reader`, `ggml-cpu.cpp`, `gguf_set_kv`, `gguf.cpp`, `ggml_opt_build`, `x86/cpu-feats.cpp`, `spine_mem_pool.cpp`, `whisper_decoder`, `whisper_context`, `whisper.cpp`, `ggml-backend-reg.cpp`, `whisper_full_with_state`, `size`, `whisper_vad_context`, `size`, `ggml_backend_load_best`, `vector`, `ggml-backend-meta.cpp`?**
...
- **What connects `schemaVersion`, `minAppVersion`, `models` to the rest of the system?**
  _4331 weakly-connected nodes found - possible documentation gaps or missing edges._
