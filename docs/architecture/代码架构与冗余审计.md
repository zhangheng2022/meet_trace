...
- `graphify update .`：代码图更新为 4,676 nodes / 6,274 edges / 396 communities。代码关系已同步；CLI 仍提示 Markdown 语义更新需要 AI 管线，且已有标签数量与当前 communities 不一致，不能把文档语义图视为完全同步。

## 8. 文档关系

- 产品范围：[PRD V0.7](../product/Alpha_PRD_无登录版.md)
- 技术实现：[端侧 SenseVoice 转录技术方案](../technical/端侧_SenseVoice_转录技术方案.md)
