...
> 状态：活动；Android 已有公开 Alpha，iOS 已具备 TestFlight 上传链路，Windows 已有固定 Store 身份的正式候选 job；Store 限定受众/Flight、正式认证、自动更新及三平台统一发布尚未闭环
>
> 更新日期：2026-08-20
>
...
| Windows 发布门禁 | `quality.yml` 开发探针；`alpha-release.yml` Store 候选 | 固定 Store 身份、三平台同 SHA/版本；待闭环限定受众/Flight、正式认证和 Store 内置更新 |
...
最终公开决策由 `github-release` 批准人承担，操作见[发布流程](../project/GitHub_版本发布流程.md)。批准人核对构建、自动化、候选身份、不可变资产和分发状态，不核对目标设备人工证据。
