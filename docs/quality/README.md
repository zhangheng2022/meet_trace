...
| Windows | Windows 10 22H2/11 x64、固定 Store 身份 | 规划中/未就绪；MSIX 审计、Private audience/Flight、正式认证与统一公开已通过，安装、卸载与 Store 更新纵向自动化仍待闭环 |
