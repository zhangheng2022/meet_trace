...
- 生产入口装配启动恢复、SQLite Repository、内置 Paraformer/VAD 准备、精确 Engine Factory、可靠录音和 ASR 预览协调器。
...
2. 首次启动完成 81,904,027 字节标准模型和 212,860 字节 VAD 的应用私有目录准备。
3. UI 树确认会议空状态、开始会议、标准模型选择和开始录音入口。
